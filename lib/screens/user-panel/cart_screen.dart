...
import 'package:e_commers/controllers/cart_price_controller.dart';
...
class _CartScreenState extends State<CartScreen> {
  // Firebaseanalytic.instance.LogEvent(name:'cart_screen')
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        backgroundColor: AppConstant.appMainColor,
                        backgroundImage:
                            NetworkImage(cartModel.productImages[index]),
                      ),
